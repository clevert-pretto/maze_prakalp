...
/*
   USART Read/Write model variables used by the application:
    ...
    gpshandleUSART0 : the USART driver handle returned by DRV_USART_Open
...
*/
    DRV_HANDLE gpshandleUSART0;
    size_t     usartReadWriteRxIndex;
	uint8_t    usartRWRxData[GPSAPP_DRV_USART_RW_RX_SIZE];
