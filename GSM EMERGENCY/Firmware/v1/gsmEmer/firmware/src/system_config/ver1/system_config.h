...
#define SYS_PORT_AD1PCFG        ~0xffbf
...
#define DRV_SPI_NUMBER_OF_MODULES		1
...
#define DRV_USART_INIT_FLAGS_IDX0                   2
...
#define DRV_USART_INIT_FLAGS_IDX1                   2
...
/*
   USART Read Write model constants used by the application:
       ...
       GSMAPP_DRV_USART  : Identifies the USART Driver instance to use

       GSMAPP_DRV_USART_RW_RX_SIZE     : The length of the receive buffer
*/
#define GSMAPP_DRV_USART                 0
#define GSMAPP_DRV_USART_RW_RX_SIZE      10

/*** Application Instance 2 Configuration ***/
/*
   USART Read Write model constants used by the application:
   
       GPSAPP_DRV_USART  : Identifies the USART Driver instance to use

       GPSAPP_DRV_USART_RW_RX_SIZE     : The length of the receive buffer
*/
#define GPSAPP_DRV_USART                 0
#define GPSAPP_DRV_USART_RW_RX_SIZE      10
