...
/*
   USART Read/Write model variables used by the application:
    ...
    gsmhandleUSART0 : the USART driver handle returned by DRV_USART_Open
...
*/
    DRV_HANDLE gsmhandleUSART0;
    size_t     usartReadWriteRxIndex;
	uint8_t    usartRWRxData[GSMAPP_DRV_USART_RW_RX_SIZE];
